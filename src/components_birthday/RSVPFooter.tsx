        ...
        <AnimatePresence mode="wait">
          ...
          {status === "success" ? (
            ...
            >
              ...
              <h2 style={{ fontSize: "1.8rem", fontWeight: 800, color: "var(--foreground)", marginBottom: 12 }}>
                RSVP has Closed
              </h2>
              <p style={{ color: "var(--muted-foreground)", fontSize: "1.05rem", lineHeight: 1.6, maxWidth: 400, margin: "0 auto" }}>
                The deadline for responding to this invitation has passed ({event?.rsvp_deadline ? new Date(event.rsvp_deadline).toLocaleDateString() : 'N/A'}).
