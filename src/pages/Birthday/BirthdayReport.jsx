...
const BirthdayReport = () => {
    ...
    return (
        <div className="admin-page rsvp-report">
            {successMessage && (
            ...
            <section className="report-stats">
                ...
                <div className="stat-card">
                    ...
                    <div className="stat-info">
                        <h3>{guests.filter(g => g.attending === true || String(g.attending).toLowerCase() === 'yes' || String(g.attending).toLowerCase() === 'attending').length}</h3>
                        <p>Attending</p>
                    </div>
                </div>
                <div className="stat-card">
                    ...
                    <div className="stat-info">
                        <h3>{guests.filter(g => g.attending === false || String(g.attending).toLowerCase() === 'no' || String(g.attending).toLowerCase() === 'declined').length}</h3>
                        <p>Declined</p>
                    </div>
                </div>
                <div className="stat-card">
                                ...
                                <tbody>
                                    {pendingGuests.map((guest) => (
                                        <tr key={guest.id}>
                                            ...
                                            <td>
                                                <span className={`status-badge ${guest.attending === true || String(guest.attending).toLowerCase() === 'yes' ? 'yes' : 'no'}`}>
                                                    {guest.attending === true || String(guest.attending).toLowerCase() === 'yes' ? 'Yes' : 'No'}
                                                </span>
                                            </td>
                                            <td className="guests-cell">{guest.guests_count || 1}</td>
                                            <td>
                                        ...
                                        <tr key={guest.id} className={editingId === guest.id ? 'editing' : ''}>
                                            ...
                                            {editingId === guest.id ? (
                                                ...
                                                <>
                                                    ...
                                                    <td>
                                                        <span className={`status-badge ${guest.attending === true || String(guest.attending).toLowerCase() === 'yes' || String(guest.attending).toLowerCase() === 'attending' ? 'yes' : 'no'}`}>
                                                            {guest.attending === true || String(guest.attending).toLowerCase() === 'yes' || String(guest.attending).toLowerCase() === 'attending' ? (
