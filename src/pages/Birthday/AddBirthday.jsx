                ...
                {loading && !isEditMode ? (
                    ...
                    <div className="bd-form-content-card">
                        ...
                        <h2 className="bd-section-title">
                            <i className="fas fa-layer-group" /> Choose Template
                        </h2>
                        <div className="bd-grid-2" style={{ marginBottom: 30 }}>
                            <div
                                className={`bd-template-option ${form.template_id === 1 ? 'active' : ''}`}
                                onClick={() => setForm(p => ({ ...p, template_id: 1 }))}
                            >
                                <div style={{ height: 120, width: '100%', background: 'linear-gradient(45deg, #1a1a1a, #000)', borderRadius: 10, marginBottom: 10, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                    <span style={{ color: '#f4d05c', fontFamily: 'Sacramento', fontSize: '1.5rem' }}>Classic Gold</span>
                                </div>
                                <div style={{ textAlign: 'center', fontWeight: 600 }}>Template 1 (Playful)</div>
                            </div>
                            ...
                            >
                                <div style={{ height: 120, width: '100%', background: '#0a0a0a', borderRadius: 10, marginBottom: 10, display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid rgba(255,255,255,0.1)' }}>
                                    <span style={{ color: '#f4d05c', fontFamily: 'Playfair Display', fontSize: '1.2rem', fontWeight: 700 }}>ROYAL NOIR</span>
                                </div>
                                <div style={{ textAlign: 'center', fontWeight: 600 }}>Template 2 (Mature)</div>
                            </div>
                        </div>

                        {/* ── Visual Mode ── */}
                        <h2 className="bd-section-title">
                            <i className="fas fa-palette" /> Visual Mode (Default)
                        </h2>
                        <div className="bd-grid-2" style={{ marginBottom: 30 }}>
                            <div
                            ...
                            >
                                <div style={{ height: 60, width: '100%', background: '#000', borderRadius: 10, marginBottom: 10, display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid #333' }}>
                                    <i className="fas fa-moon" style={{ color: '#f4d05c' }} />
                                </div>
                                <div style={{ textAlign: 'center', fontWeight: 600 }}>Dark Mode</div>
                            </div>
                            ...
                            >
                                <div style={{ height: 60, width: '100%', background: '#fff', borderRadius: 10, marginBottom: 10, display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid #ddd' }}>
                                    <i className="fas fa-sun" style={{ color: '#c5a021' }} />
                                </div>
                                <div style={{ textAlign: 'center', fontWeight: 600 }}>Light Mode</div>
                            </div>
                        </div>
                        ...
                        <div className="bd-grid-2">
                            ...
                            <div className="bd-form-group">
                                ...
                                <p style={{ fontSize: '0.8rem', color: '#888', marginTop: '8px' }}>
                                    <i className="fas fa-info-circle"></i> <strong>Can't find the venue?</strong> Search for a nearby area and <strong>drag the red pin</strong> on the map above to the exact spot.
                                </p>
                            </div>
                        </div>
