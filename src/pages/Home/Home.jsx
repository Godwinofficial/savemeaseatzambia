// Home.jsx - Main Application Component (Forced Reload)
            ...
            >
                {sliderImages.map((img, index) => (
                    <div
                        ...
                        style={{
                            backgroundImage: `linear-gradient(135deg, ${index === 0 ? 'rgba(38, 150, 145, 0.4)' : index === 1 ? 'rgba(29, 133, 127, 0.4)' : 'rgba(38, 150, 145, 0.5)'}, ${index === 0 ? 'rgba(38, 150, 145, 0.5)' : index === 1 ? 'rgba(38, 150, 145, 0.4)' : 'rgba(29, 133, 127, 0.4)'}), url("${img}")`,
...
const Templates = () => {
    const templates = [
        ...
        },
        {
            ...
            title: 'Editorial Bridal Shower',
            description: 'A premium, editorial-style template for bridal showers with elegant typography and custom gallery.',
            link: '/bridal-shower',
            available: true
        },
        {
